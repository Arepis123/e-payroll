    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <flux:button variant="outline" href="{{ route('admin.invoices.download', $invoice->id) }}">
                    <flux:icon.arrow-down-tray class="size-4" />
                    Download PDF
                </flux:button>
                <flux:button variant="outline" href="{{ route('admin.invoices') }}" wire:navigate>
                    ...
                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                        ...
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                            ...
                            <td class="py-3">
                                ...
                                @else
                                    <span class="text-xs text-zinc-400 dark:text-zinc-500 text-right block">-</span>
                                @endif
                            </td>
