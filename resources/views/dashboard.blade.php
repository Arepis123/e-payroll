    ...
    <div id="newsModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-[2px] opacity-0 invisible transition-all duration-300">
        <div class="relative w-full max-w-2xl mx-4 bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl overflow-hidden transform scale-95 transition-transform duration-300">
            ...
            <div id="carouselContainer" class="relative pt-14">
                    ...
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="md:w-2/3 p-8">
                            ...
                            <p class="text-zinc-600 dark:text-zinc-400 mb-4">
                                ...
                                You have successfully logged in to e-Payroll CLAB system.
                            </p>
                ...
                <!-- Slide 2: Pending Payments Alert -->
                <div class="carousel-slide">
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="md:w-2/3 p-8">
                            <h2 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-2">Pending Payments</h2>
                            <p class="text-zinc-600 dark:text-zinc-400 mb-4">
                            ...
                            <flux:button variant="primary" href="{{ route('salary') }}" wire:navigate onclick="closeNewsModal()">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="p-6 bg-white dark:bg-zinc-900">
                            ...
                            <p class="text-sm text-zinc-600 dark:text-zinc-400">
                                Stay tuned for more updates and features coming to e-Payroll CLAB.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <flux:card class="space-y-2 p-4 sm:p-6 dark:bg-zinc-900 rounded-lg">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-zinc-600 dark:text-zinc-400">Pending Payments</p>
                        <p class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">7</p>
                    </div>
                ...
                <div class="flex items-center gap-2 text-xs">
                    <span class="text-orange-600 dark:text-orange-400">Awaiting payment</span>
                </div>
            </flux:card>
        </div>
                ...
                <flux:card class="p-4 sm:p-6 dark:bg-zinc-900 rounded-lg">
                    ...
                    <div class="space-y-3">
                        <div class="flex gap-3 rounded-lg bg-orange-50 dark:bg-orange-900/20 p-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-zinc-900 dark:text-zinc-100">Payment Deadline</p>
                                <p class="text-xs text-zinc-600 dark:text-zinc-400">7 payments due before month end</p>
                            </div>
                        </div>
